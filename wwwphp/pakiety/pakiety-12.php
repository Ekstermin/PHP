				...
				<div id="text">
					...
					<p>
						...
						<div class="oferta">
							...
							<span class="kanaly"  style="text-align:center; margin-left:60px;">10 Mb/s</span>
							</br></br>
							<div class="pakiet" style="text-align:center;margin-left:60px;"><div id="p30"></div></div>
							</br>							
							...
							<br/>
								<a href="https://telewizjaswiatlowodowa.pl/wybierz-pakiet" class="kanaly" target="_blank">65 Kanałów</a> &nbsp;(35 HD)<br/><br/>
							...
							<div class="separator"></div>
								<table class="punkty" style="margin-bottom:40px">
									...
									<tr><td><a href="http://www.evio.info/project/evod/" class="kanaly" target="_blank"><i class="icon-check"></i>eVOD</a></td></tr>
									<tr><td>&nbsp;<i class="icon-minus"></i>Timeshift</td></tr>
									<tr><td><a href="http://www.evio.info/nowa-usluga-evio-ego-twoja-telewizja-zawsze-i-wszedzie/" class="kanaly" target="_blank"><i class="icon-minus"></i>e-GO</a></td></tr></table>
						...
						<div class="oferta">
							...
							<span class="kanaly"  style="text-align:center; margin-left:60px;">30 Mb/s</span>
							</br></br>
							<div class="pakiet" style="text-align:center;margin-left:60px;"><div id="p45"></div></div>
							</br>
						...
						<div class="oferta">
							...
							<span class="kanaly"  style="text-align:center; margin-left:60px;">50 Mb/s</span>
							</br></br>
							<div class="pakiet" style="text-align:center;margin-left:60px;"><div id="p60"></div></div>
							</br>
							...
							<table class="punkty" style="margin-bottom:40px">
								...
								<tr>
									<td>
										<a href="http://www.evio.info/nowe-aplikacje-na-dekoderze-ebox-m15/" class="kanaly" target="_blank"><i class="icon-check"></i> Multimedia</a>
									</td>
								</tr>
								
								<tr>
									<td>
										<a href="http://www.evio.info/project/eepg-dosyl-metadanych-epg/" class="kanaly" target="_blank"><i class="icon-check"></i> Epg</a>
									</td>
								</tr>
								
								<tr>
									<td>
										<a href="http://www.evio.info/epvr-na-dekoderze-ebox-m15/" class="kanaly" target="_blank"><i class="icon-check"></i>ePVR nagrywarka</a>								
									</td>
								</tr>
								<tr>
									<td>
									<a href="http://www.evio.info/catchup-tv-na-dekoderach-ebox-m15/" class="kanaly" target="_blank"><i class="icon-check"></i> Catch-UP</a>
									</td>
								</tr>
								<tr>
									<td>
										&nbsp;<i class="icon-check"></i> Start-over
									</td>
								</tr>
								<tr>
									<td>
										<a href="http://www.evio.info/project/evod/" class="kanaly" target="_blank"><i class="icon-check"></i> eVOD</a>
									</td>
								</tr>
								<tr>
									<td>
										&nbsp;<i class="icon-check"></i>Timeshift
									</td>
								</tr>
								<tr>
									<td>
										<a href="http://www.evio.info/nowa-usluga-evio-ego-twoja-telewizja-zawsze-i-wszedzie/" class="kanaly" target="_blank"><i class="icon-check"></i> e-GO</a>
									</td>
								</tr>
							</table>
						...
						<div class="oferta">
							...
							<span class="kanaly"  style="text-align:center; margin-left:60px;">100 Mb/s</span>
							</br></br>
							...
							<table class="punkty" style="margin-bottom:40px">
								...
								<tr>
									<td>&nbsp;<i class="icon-check"></i>Timeshift</td>
								</tr>
								<tr>
									<td>
										<a href="http://www.evio.info/nowa-usluga-evio-ego-twoja-telewizja-zawsze-i-wszedzie/" class="kanaly" target="_blank"><i class="icon-check"></i> e-GO</a>
