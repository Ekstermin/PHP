			...
			<div id="text" style="margin-top:50px;margin-bottom:50px;">
				...
				<div id="kon" >
					<div class="kon" >
						...
						<div class="kon1" style="background: #00800036;"><a>Pomoc techniczna</a></div>
				...
				<div id="ko">
					...
					?>
						<form action="sprzedaz_wyslij.php" method="post" enctype="multipart/form-data">
							<input type="hidden" name="test" value="pomoc techniczna" />
						...
						?></textarea><br/>
							...
							<input type="file" name="attachment" accept=".jpg, .jpeg, .png, .pdf, .gif"/><br/><br/>
							<input type="file" name="attachment2" accept=".jpg, .jpeg, .png, .pdf, .gif"/><br/><br/>
